...
export declare namespace Tag {
	enum AttachmentType {
		/** Type not yet determined (default). Resolved via oEmbed when displayed. */
...
interface R3F {
	...
	focus(target: THREE.Vector3 | THREE.Box3, options?: {
		from?: THREE.Vector3;
		mode?: Mode.Mode.INSIDE | Mode.Mode.DOLLHOUSE | Mode.Mode.FLOORPLAN | Mode.Mode.EXTERIOR;
		transition?: Camera.TransitionType;
	}): Promise<void>;
